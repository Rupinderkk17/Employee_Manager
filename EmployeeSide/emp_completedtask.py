...
class CompletedTask:
    def __init__(self):
        ...
        self.t.title("Complete Task Details Of Employee")
    ...
    def getData(self):
            for i in emp_database.showcompletetask(self.email, "Complete"):
                print(i)
                self.tr.insert('', 'end', text=i[0], values=(i[1], i[2], i[3], i[4], 'COMPLETE'))
